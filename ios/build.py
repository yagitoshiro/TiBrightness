...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','org.selfkleptomaniac.mod.tibrightness.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','OrgSelfkleptomaniacModTibrightnessModuleAssets.m')
