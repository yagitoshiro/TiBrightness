...
// This proxy can be created by calling Tibrightnessandroid.createExample({message: "hello world"})
@Kroll.proxy(creatableInModule=TibrightnessandroidModule.class)
